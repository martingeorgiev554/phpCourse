...
switch ($_POST['req']) {
  ...
  case "show":
    ...
    <table id="cart-table">
      ...
      <?php }} else { ?>
      <tr><td colspan="3">Shopping Cart is Empty</td></tr>
      <?php } ?>
      <tr>
        <td colspan="2"></td>
    ...
    <form id="cart-checkout" onsubmit="return cart.checkout();">
      <label>Name</label>
      <input type="text" id="co_name" required value="Enter your name"/>
      <label>Email</label>
      <input type="email" id="co_email" required value="Enter your Email"/>
